                            ...
                            <dd class="td">
                                <div class="error-list">
                                    <?php echo $this->Form->input('kaisyanm', array('type' => 'text',
                                                        ...
                                                        'class' => 'doublebyte ime-ModeEnable')); ?>
                        ...
                        <dl class="table required_form">
                            ...
                            <dd class="td">
                                <div class="error-list" style="width: 100%;">
                                    <img src="data:image/jpeg;base64,<?php echo $this->request->data['captchaImageData']; ?>" alt="CAPTCHA" class="captcha-image" style="width:auto;vertical-align: middle;height: 50px;">
                                    <img src= "<?php echo $this->base;?>/app/webroot/img/common/refresh.png" class="refresh-captcha" title="キャプチャを更新するには、ここをクリックしてください。" style="width: 25px; cursor: pointer; vertical-align: middle;"/>
