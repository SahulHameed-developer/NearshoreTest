...
<section class="main">
	<div class="container">
		<main>
			<ol class="breadcrumbs" style="display: inline-block;"></ol>
			<div class="f_right breadcrumbs"><a style="cursor:pointer;" id="backpage_head" class="listBack">PR情報一覧へ戻る</a></div>
			<h1 class="main-title">PR商品情報 新規追加</h1>
			<?php echo $this->Form->create('menu', ['id' => 'menuFrm', 'url' => ['controller' => 'AdminProductsite', 'action' => 'index']]);
			echo $this->Form->end(); ?>
