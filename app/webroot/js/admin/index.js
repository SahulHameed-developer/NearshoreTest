$(document).ready(function() {
	...
	if ($('#flashMessage').length != 0) {
		$("#username-field").css("background", "#FFF5F5");
		$("#pw-field").css("background", "#FFF5F5");
	}
	$('#loginbtn').click(function() {
		// エラーメッセージを削除。
		$( "#flashMessage" ).empty();
		if($("#username-field").val() !=""){
			$("#username-field").css("background-color", "white");
		}
		if($("#pw-field").val()!=""){
			$("#pw-field").css("background-color", "white");
		}
	});
	$('#pw-field').keyup(function() {
