$(document).ready(function() {
	...
	// 公開区分項目の設定、有益登録権限　=　"0"［権限あり］ 有益公開権限　=　"1"［権限なし］の場合
	if($("#yuekitouroku").val()=='0' && $("#yuekikoukai").val()=='1' && $("#kanrikbnhdn").val() < SYS_KANRISHA){
		...
		$('#yuekidate').attr('disabled','disabled');
		$('#yuekitime').attr('disabled','disabled');
		$('#kaiinnm').attr('disabled','disabled');
		$('#title').attr('disabled','disabled');
		$('#naiyo').attr('disabled','disabled');
		$('#sankourl').attr('disabled','disabled');
	...
	$(".rstEdtSyasin1").click(function () {
		...
		if($("#urlsyasin1").val()=="") {
			...
			$("#thum01").attr('src', $("#baseurl").val()+'/AdminBeneficial/getSyasin/'+$("#urlsyasin1").val()+'/'+$("#urlsyasinKey").val());
		}
	});
	// 編集写真2のリセット
	$(".rstEdtSyasin2").click(function () {
		...
		if($("#urlsyasin2").val()=="") {
			...
			$("#thum02").attr('src', $("#baseurl").val()+'/AdminBeneficial/getSyasin/'+$("#urlsyasin2").val()+'/'+$("#urlsyasinKey").val());
		}
	});
	// 編集写真3のリセット
	$(".rstEdtSyasin3").click(function () {
		...
		if($("#urlsyasin3").val()=="") {
			...
			$("#thum03").attr('src', $("#baseurl").val()+'/AdminBeneficial/getSyasin/'+$("#urlsyasin3").val()+'/'+$("#urlsyasinKey").val());
		}
	});
				...
				submitHandler: function(form) {
					if($('#previewflg').val() == 1 ) {
						if($("#yuekitouroku").val()=='0' && $("#yuekikoukai").val()=='1' && $("#kanrikbnhdn").val() < SYS_KANRISHA){
							...
							$('#yuekidate').attr('disabled',false);
							$('#yuekitime').attr('disabled',false);
							$('#kaiinnm').attr('disabled',false);
							$('#title').attr('disabled',false);
							$('#naiyo').attr('disabled',false);
							$('#sankourl').attr('disabled',false);
		...
		buttons: {
			OK: {
				action: function(){
					...
					$('#adminBeneficialregister').attr('action', '../AdminBeneficial/update');
