...
class DATABASE_CONFIG {
	...
	public $default = array(
		...
		'port' => '3307',					// ポート番号
		'login' => 'ae202424qn',			// ログインID
		'password' => 'nsit56-asda54dyh',	// パスワード


		// テストサイト用設定
		'database' => 'ae202424qn_dbtest01',	// データベース名

		// 公開確認用設定
		// 'database' => 'ae202424qn_dbconf01',	// データベース名
		
		// 公開用設定
		// 'database' => 'ae202424qn_dbnsit01',	// データベース名
