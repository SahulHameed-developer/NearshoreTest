...
// define("BASE_PATH", "https://localhost/shisankei/SOURCE/nearshore"); // For local
define("BASE_PATH", "https://ae202424qn.smartrelease.jp"); // For Server
/**
 ...
 */
	...
	Configure::write('Security.salt', 'DYhG93b0qyJfIxfs2guVoUubWwvniR2G0Fasdasd');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	//Configure::write('Security.cipherSeed', '76859309657453542496749683645');
	Configure::write('Security.cipherSeed', '76859309657453542496749683222');
