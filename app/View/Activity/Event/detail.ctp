...
<!-- /header -->
<?php echo $this->Form->create('shosaiModoruFrm', ['id' => 'shosaiModoruFrm', 'url' => ['controller' => 'activity', 'action' => 'search'.$curtime]]);
...
<?php echo $this->Form->create('moshiKomiFrm', ['id' => 'moshiKomiFrm', 'url' => ['controller' => 'activity', 'action' => 'entry']]);
	...
	echo $this->Form->end();
?>
<?php echo $this->Form->create('moshiKomitorikeshiFrm', ['id' => 'moshiKomitorikeshiFrm', 'url' => ['controller' => 'activity', 'action' => 'cancel'.$curtime]]);
	...
	echo $this->Form->input('sosikinm', array('type' => 'hidden','value'=>$selectedSosikinm));
	echo $this->Form->input('kbunruinm', array('type' => 'hidden','value'=>$selectedKbunruinm));
	echo $this->Form->input('screenName', array('type' => 'hidden','value'=>'event'));
?>
				...
				<div class="article type_01">
					<div class="article_wrap">
						<div class="article_block">
							...
							<?php if ($event_shousai['TKatudo']['kbunruicd'] == $kouenkai || $event_shousai['TKatudo']['kbunruicd'] == $jinzaiikusei) {?>
							<dl class="break_line">
								<dt>講師</dt>
							...
							<?php if ($event_shousai['TKatudo']['kbunruicd'] == $Kenshukai || 
										$event_shousai['TKatudo']['kbunruicd'] == $kengakukai ||
										$event_shousai['TKatudo']['kbunruicd'] == $jinzaiikusei ||
											$event_shousai['TKatudo']['kbunruicd'] == $kouryuuibento) {?>
								<dl class="break_line">
									<dt>集合場所</dt>
				...
				<div class="event_link_block clearfix">
					...
					<div class="link_item event_contact wf-roundedmplus1c f_right">
						<a href="javascript:;" class="moshiKomi"
							data-arno="<?php echo $event_shousai['TKatudo']['arno'];?>">お申し込み</a>
					</div>
					<?php } else { ?>
					<div class="link_item event_contact wf-roundedmplus1c f_right">
						<a href="javascript:;" class="moshiKomitorikeshi" data-arno="<?php echo $event_shousai['TKatudo']['arno'];?>">お申し込み取り消し</a>
					</div>
					<?php } ?>
				</div>
				<?php } ?><!-- /.link_block -->
