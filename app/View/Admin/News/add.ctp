<!doctype html>
<title>お知らせ 新規追加：一般社団法人ニアショアＩＴ協会 管理画面</title>
...
<?= $this->Html->script('admin/news/add.js') ?>
<script>
  $(function() {
	...
	<div class="container">
		<main>
			<ol class="breadcrumbs" style="display: inline-block;">
				...
				--><li style="display: inline-block;">お知らせ 新規追加</li>
			</ol><!-- /.breadcrumbs -->
			...
			<h1 class="main-title">お知らせ 新規追加</h1>
			<?php echo $this->Form->create('menu', ['id' => 'menuFrm', 'url' => ['controller' => 'admin', 'action' => 'home']]);?>
			<?php echo $this->Form->end();?>
			<?php echo $this->Form->create('adminNewsregister', ['enctype' => 'multipart/form-data','id' => 'adminNewsregister', 'url' => ['controller' => 'adminNews', 'action' => 'register']]);?>
			...
			<div class="form-area">
				<dl class="form-common">
					...
					<div class="error-list">
						<?php echo $this->Form->input('osirasedate', array('class'=>'datepicker','id'=>'osirasedate','label'=>false,'type'=>'text','name'=>'osirasedate','value' => date('Y/m/d'),'maxlength' => '10')); ?>
					</div>
				...
				<dl class="form-common">
					...
					<dd>
					<div class="error-list">
					<?php echo $this->Form->input('osirasetime', array('type' => 'text','id' => 'osirasetime', 'label' => false, 'class' => 'ime-ModeDisable timebox','name'=>'osirasetime','value' => date('H:i'), 'onkeypress' => 'return checkTimeValue(event, id, "title");'));?>
					</div>
				...
				<dl class="form-common">
					...
					<dd><div class="error-list"><?php echo $this->Form->textarea(' ', array('id'=>'naiyo','name'=>'naiyo','maxlength'=>'1024','class' => 'noTrimSpace','style'=>'width:668px;resize: none;'));?></div>
