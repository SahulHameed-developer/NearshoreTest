<!doctype html>
<title>委員会紹介情報編集：一般社団法人ニアショアＩＴ協会 管理画面</title>
<?= $this->Html->script('common/jquery.min.js') ?>
<?= $this->Html->script('common/jquery-validate.js') ?>
<?= $this->Html->script('admin/CommitteInfo/edit.js') ?>
	...
	<div class="container">
		<main>
			<ol class="breadcrumbs" style="display: inline-block;">
				<li style="display: inline-block;"><a style="cursor:pointer;" class="menuBack">管理画面トップ</a></li><li  style="display: inline-block;">委員会紹介情報 編集</li>
			</ol><!-- /.breadcrumbs -->
			...
			<h1 class="main-title">委員会紹介情報 編集</h1>
			<?php echo $this->Form->create('menu', ['id' => 'menuFrm', 'url' => ['controller' => 'admin', 'action' => 'home']]); echo $this->Form->end();?>
			<?php echo $this->Form->create('frmAdminCommitteesearch', ['enctype' => 'multipart/form-data','id' => 'frmAdminCommitteesearch', 'url' => ['controller' => 'AdminCommitteInfo', 'action' => 'search']]);?>
					...
					<div class="conference-search">
						<div class="select-wrap">
							<div style="display: inline-block;">
								<?php echo $this->Form->input('iinkaicd',array('type'=>'select',
																'options'=>$combocommittee,
																'label'=>false,
							...
							<div style="display: inline-block;">
								<?php echo $this->Form->button("検索", array('class' =>'buttonsearch','disabled' => $disflg,'name' =>'kaigibtn','style'=>'padding:0.38rem 1rem;','controller' => 'AdminMaster','action'=> 'search'));?>
							</div>
						</div>
					</div>
				</div>
			<?php echo $this->Form->end();?>
			<?php echo $this->Form->create('frmAdminCommittee', ['enctype' => 'multipart/form-data','id' => 'frmAdminCommittee', 'url' => ['controller' => 'AdminCommitteInfo', 'action' => 'register']]);?>
			...
			<?php echo $this->Form->input('', array('type' => 'hidden','name'=>'iinkaicdinsert','id'=>'iinkaicdinsert','value'=> '')); ?>
			<?php echo $this->Form->input('', array('type' => 'hidden','name'=>'iinkainm','id'=>'iinkainm','value'=> '')); ?>
			<div class="form-area">
				<dl class="form-common">
					<dt class="required"><label for="gaiyou">概要</label></dt>
					<dd><div class="">
						<?=$this->Form->textarea('gaiyou', array( 'label' => false, 'name' => 'gaiyou', 'id' => 'gaiyou','value' => (isset($committee[0]['TIinkai']['gaiyou'])) ? $committee[0]['TIinkai']['gaiyou'] : '','class' => 'doublebyte','escape' => false, 'disabled' => $disflg,'style'=>'resize:none;'));?>
						<font color='red'><label class="gaiyou"></label></font>
					</div></dd>
				</dl>
				<dl class="form-common">
					<dt><label for="syokumu">業務内容</label></dt>
					<dd><div class="">
						<?=$this->Form->textarea('syokumu', array( 'label' => false, 'name' => 'syokumu', 'id' => 'syokumu','value' => (isset($committee[0]['TIinkai']['syokumu'])) ? $committee[0]['TIinkai']['syokumu'] : '','class' => 'doublebyte','escape' => false, 'disabled' => $disflg,'style'=>'resize:none;'));?>
						<font color='red'><label class="syokumu"></label></font>
					</div></dd>
				</dl>
				<dl class="form-common">
					<dt><label for="lgid">委員長</label></dt>
					<dd id="chairman">
						<div class="doublebyte">
				...
				<dl class="form-common">
					<dt><label for="kaiinbikou">委員</label></dt>
					<dd id="commissioner">
						<div>
						<table>
						<?php if(isset($commissioner)) { ?>
						<?php foreach ($commissioner as $key => $commissioner) { ?>
						<tr>
							<td><?php echo (isset($commissioner['TKaisya']['kaisyanm'])) ? $commissioner['TKaisya']['kaisyanm'] : ''; ?></td>
							<td><?php echo (isset($commissioner['TKaiin']['kaiinnm'])) ? "　".$commissioner['TKaiin']['kaiinnm'] : ''; ?></td>
						</tr>
						<?php } ?>
						<?php } ?>
						</table>
				...
				<dl class="form-common">
					<dt><label for="njyoken">入会条件</label></dt>
					<dd><div class="">
						<?=$this->Form->textarea('njyoken', array( 'label' => false, 'name' => 'njyoken', 'id' => 'njyoken','value' => (isset($committee[0]['TIinkai']['njyoken'])) ? $committee[0]['TIinkai']['njyoken'] : '','class' => 'doublebyte','maxlength'=>'512', 'escape' => false, 'disabled' => $disflg,'style'=>'resize:none;'));?>
						<font color='red'><label class="njyoken"></label></font>
					</div></dd>
				</dl>
				<dl class="form-common">
					<dt><label for="nhouhou">入会方法</label></dt>
					<dd><div class="">
						<?=$this->Form->textarea('nhouhou', array( 'label' => false, 'name' => 'nhouhou', 'id' => 'nhouhou','value' => (isset($committee[0]['TIinkai']['nhouhou'])) ? $committee[0]['TIinkai']['nhouhou'] : '','class' => 'doublebyte','maxlength'=>'512', 'escape' => false, 'disabled' => $disflg,'style'=>'resize:none;'));?>
				...
				<dl class="form-common">
					...
					<dd><div class="">
						<?=$this->Form->textarea('bikou', array( 'label' => false, 'name' => 'bikou', 'id' => 'bikou','value' => (isset($committee[0]['TIinkai']['bikou'])) ? $committee[0]['TIinkai']['bikou'] : '','class' => 'doublebyte','escape' => false, 'disabled' => $disflg,'style'=>'resize:none;'));?>
					...
					<dt class="thum_title requireds">
						<div class="thum_box ">
							...
							<figure class="thum_02">
								...
								<?php }else{?>
									<img src="<?php echo $this->base."/AdminCommitteInfo/getSyasin/".$syasinData['syasin']."/".$isyasinkey;?>" id="thum" style="max-height: 53px;max-width: 73px;width: auto!important;"/>
									<?php echo $this->Form->input('', array('type' => 'hidden','name'=>'image','id'=>'image','value'=> $this->base."/Committee/getSyasin/".$syasinData['syasin']."/".$isyasinkey )); ?>
								<?php } ?>
							</figure>
						</div>
				...
				<dl class="form-common">
					<dt class="thum_title">
						<div class="thum_box">
							...
							<figure class="thum_02">
								...
								<?php }else{?>
									<img src="<?php echo $this->base."/AdminCommitteInfo/getSyasin/".$syasinData['syasin1']."/".$ssyasinkey;?>" id="thum01" style="max-height: 53px;max-width: 73px;width: auto!important;"/>
									<?php echo $this->Form->input('', array('type' => 'hidden','name'=>'image1','id'=>'image1','value'=> $this->base."/Committee/getSyasin/".$syasinData['syasin1']."/".$ssyasinkey )); ?>
								<?php } ?>
							</figure>
						</div>
					...
					<dd class="photo">
						<div><input type="text" name="syasin1Path" id="syasin1Path" readonly><button type="button" class ="syasin1btn"
									>画像選択</button></div>
				...
				<dl class="form-common">
					<dt class="thum_title">
						<div class="thum_box">
							...
							<figure class="thum_02">
								...
								<?php }else{?>
									<img src="<?php echo $this->base."/AdminCommitteInfo/getSyasin/".$syasinData['syasin2']."/".$ssyasinkey;?>" id="thum02" style="max-height: 53px;max-width: 73px;width: auto!important;"/>
									<?php echo $this->Form->input('', array('type' => 'hidden','name'=>'image2','id'=>'image2','value'=> $this->base."/Committee/getSyasin/".$syasinData['syasin2']."/".$ssyasinkey )); ?>
								<?php } ?>
							</figure>
						</div>
					...
					<dd class="photo">
						<div><input type="text" name="syasin2Path" id="syasin2Path" readonly><button type="button" class ="syasin2btn"
									>画像選択</button></div>
				...
				<dl class="form-common">
					<dt class="thum_title">
						<div class="thum_box">
							...
							<figure class="thum_02">
								...
								<?php }else{?>
									<img src="<?php echo $this->base."/AdminCommitteInfo/getSyasin/".$syasinData['syasin3']."/".$ssyasinkey;?>" id="thum03" style="max-height: 53px;max-width: 73px;width: auto!important;"/>
									<?php echo $this->Form->input('', array('type' => 'hidden','name'=>'image3','id'=>'image3','value'=> $this->base."/Committee/getSyasin/".$syasinData['syasin3']."/".$ssyasinkey )); ?>
								<?php } ?>
							</figure>
						</div>
					...
					<dd class="photo">
						<div><input type="text" name="syasin3Path" id="syasin3Path" readonly><button type="button" class ="syasin3btn"
									>画像選択</button></div>
				...
				<dl class="form-common">
					<dt class="thum_title">
						<div class="thum_box">
							...
							<figure class="thum_02">
								...
								<?php }else{?>
									<img src="<?php echo $this->base."/AdminCommitteInfo/getSyasin/".$syasinData['syasin4']."/".$ssyasinkey;?>" id="thum04" style="max-height: 53px;max-width: 73px;width: auto!important;"/>
									<?php echo $this->Form->input('', array('type' => 'hidden','name'=>'image4','id'=>'image4','value'=> $this->base."/Committee/getSyasin/".$syasinData['syasin4']."/".$ssyasinkey )); ?>
								<?php } ?>
							</figure>
						</div>
					...
					<dd class="photo">
						<div><input type="text" name="syasin4Path" id="syasin4Path" readonly><button type="button" class ="syasin4btn"
									>画像選択</button></div>
				...
				<dl class="form-common">
					<dt class="thum_title">
						<div class="thum_box">
							...
							<figure class="thum_02">
								...
								<?php }else{?>
									<img src="<?php echo $this->base."/AdminCommitteInfo/getSyasin/".$syasinData['syasin5']."/".$ssyasinkey;?>" id="thum05" style="max-height: 53px;max-width: 73px;width: auto!important;"/>
									<?php echo $this->Form->input('', array('type' => 'hidden','name'=>'image5','id'=>'image5','value'=> $this->base."/Committee/getSyasin/".$syasinData['syasin5']."/".$ssyasinkey )); ?>
								<?php } ?>
							</figure>
						</div>
					...
					<dd class="photo">
						<div><input type="text" name="syasin5Path" id="syasin5Path" readonly><button type="button" class ="syasin5btn"
									>画像選択</button></div>
				...
				<dl class="form-common">
					<dt class="thum_title">
						<div class="thum_box">
							...
							<figure class="thum_02">
								...
								<?php }else{?>
									<img src="<?php echo $this->base."/AdminCommitteInfo/getSyasin/".$syasinData['syasin6']."/".$ssyasinkey;?>" id="thum06" style="max-height: 53px;max-width: 73px;width: auto!important;"/>
									<?php echo $this->Form->input('', array('type' => 'hidden','name'=>'image6','id'=>'image6','value'=> $this->base."/Committee/getSyasin/".$syasinData['syasin6']."/".$ssyasinkey )); ?>
								<?php } ?>
							</figure>
						</div>
					...
					<dd class="photo">
						<div><input type="text" name="syasin6Path" id="syasin6Path" readonly><button type="button" class ="syasin6btn"
									>画像選択</button></div>
				...
				<dl class="form-common">
					<dt class="thum_title">
						<div class="thum_box">
							...
							<figure class="thum_02">
								...
								<?php }else{?>
									<img src="<?php echo $this->base."/AdminCommitteInfo/getSyasin/".$syasinData['syasin7']."/".$ssyasinkey;?>" id="thum07" style="max-height: 53px;max-width: 73px;width: auto!important;"/>
									<?php echo $this->Form->input('', array('type' => 'hidden','name'=>'image7','id'=>'image7','value'=> $this->base."/Committee/getSyasin/".$syasinData['syasin7']."/".$ssyasinkey )); ?>
								<?php } ?>
							</figure>
						</div>
					...
					<dd class="photo">
						<div><input type="text" name="syasin7Path" id="syasin7Path" readonly><button type="button" class ="syasin7btn"
									>画像選択</button></div>
				...
				<dl class="form-common">
						...
						<div class="thum_box">
							...
							<figure class="thum_02">
								...
								<?php }else{?>
									...
									<?php echo $this->Form->input('', array('type' => 'hidden','name'=>'image8','id'=>'image8','value'=> $this->base."/Committee/getSyasin/".$syasinData['syasin8']."/".$ssyasinkey )); ?>
								<?php } ?>
							</figure>
						</div>
					...
					<dd class="photo">
						<div><input type="text" name="syasin8Path" id="syasin8Path" readonly><button type="button" class ="syasin8btn"
									>画像選択</button></div>
				...
				<dl class="form-common">
						...
						<div class="thum_box">
							...
							<figure class="thum_02">
								...
								<?php }else{?>
									...
									<?php echo $this->Form->input('', array('type' => 'hidden','name'=>'image9','id'=>'image9','value'=> $this->base."/Committee/getSyasin/".$syasinData['syasin9']."/".$ssyasinkey )); ?>
								<?php } ?>
							</figure>
						</div>
					...
					<dd class="photo">
						<div><input type="text" name="syasin9Path" id="syasin9Path" readonly><button type="button" class ="syasin9btn"
									>画像選択</button></div>
